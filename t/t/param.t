...
like exception { XSTest::Param::add() }, qr/Missing argument/, "dies with no args";
like exception { XSTest::Param::add(1) }, qr/Missing argument/, "dies with one arg";
...
is XSTest::Param::add_opt(1,2), 3, "add_opt with two arguments";
is XSTest::Param::add_opt(1), 1, "add_opt with one argument";
